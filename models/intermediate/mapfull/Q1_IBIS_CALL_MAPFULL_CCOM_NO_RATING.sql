...
FROM
    ...
    WHERE A.CALL_DT BETWEEN {{ get_date_sub("'2025-03-11'", 11) }} AND {{ get_date_sub("'2025-03-11'", 1) }}
...
LEFT OUTER JOIN {{ ref('IBIS_CALL') }} IIC
    ON IIC.SEGMENT_DT BETWEEN {{ get_date_sub("'2025-03-11'", 12) }} AND {{ get_date_sub("'2025-03-11'", 1) }}
   AND IIC.CALL_DT BETWEEN {{ get_date_sub("'2025-03-11'", 11) }} AND {{ get_date_sub("'2025-03-11'", 1) }}
...
LEFT OUTER JOIN {{ref('IBIS_CALL') }} OIC
    ON OIC.SEGMENT_DT BETWEEN {{ get_date_sub("'2025-03-11'", 12) }} AND {{ get_date_sub("'2025-03-11'", 1) }}
   AND OIC.CALL_DT BETWEEN {{ get_date_sub("'2025-03-11'", 11) }} AND {{ get_date_sub("'2025-03-11'", 1) }}
