...
/*
        ...
        */
        ...
        /*
        NULL AS MINIMUM_PRICE_PER_MINUTE_FEE,
        NULL AS MINIMUM_PRICE_SETUP_FEE,
        NULL AS RETAIL_PRICE_PER_MINUTE_FEE,
        NULL AS RETAIL_PRICE_SETUP_FEE 
        */
        CAST(NULL AS DECIMAL(15,6)) AS MINIMUM_PRICE_PER_MINUTE_FEE,
        CAST(NULL AS DECIMAL(15,6)) AS MINIMUM_PRICE_SETUP_FEE,
        CAST(NULL AS DECIMAL(15,6)) AS RETAIL_PRICE_PER_MINUTE_FEE,
        CAST(NULL AS DECIMAL(15,6)) AS RETAIL_PRICE_SETUP_FEE 
