...
-- TODO: list out all the columns
    ...
    A.OUT_UNIT_TARIFF_EURO,
    A.OUT_UNIT_TARIFF_SETUP_FEE_EURO,
    A.OUT_AMOUNT_EURO,
    A.OUT_AMOUNT_SETUPFEE_EURO,
    B.A_NR_CTRY_CD AS A_NR_CTRY_CD,
    B.B_NR_CTRY_CD AS B_NR_CTRY_CD,
    B.DEST_OPER_ID AS DEST_OPER_ID,
    B.CUST_OPER_ID_Final AS CUST_OPER_ID,
    B.CUST_TGC_ID_Final AS CUST_TGC_ID,
    B.CUST_CURRENCY_ID_Final AS CUST_CURRENCY_ID,
    B.CUST_DEST_SUB_SVC_ID_Final AS CUST_DEST_SUB_SVC_ID,
    B.SUPPL_OPER_ID_Final AS SUPPL_OPER_ID,
    B.SUPPL_TGC_ID_Final AS SUPPL_TGC_ID,
    B.SUPPL_CURRENCY_ID_Final AS SUPPL_CURRENCY_ID,
    B.SUPPL_DEST_SUB_SVC_ID_Final AS SUPPL_DEST_SUB_SVC_ID,
    B.ORIG_OPER_ID_Final AS ORIG_OPER_ID
    FROM {{ref('Q1_IBIS_CALL_MAPFULL_CCOM_RATING_DEDUP_POP')}} A
    LEFT JOIN {{ref('Q1_IBIS_CALL_MAPFULL_CCOM_Update_Fields')}} B
    ON A.CALL_DT = B.CALL_DT
